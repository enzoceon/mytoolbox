          ...
          <PageContainer>
            ...
            <div className="text-center mb-10 animate-fade-in">
              <h1 className="text-3xl md:text-5xl font-bold mb-4 tracking-tight">
                <span className="text-white">HTML to </span>
                <span className="bg-gradient-to-r from-purple-600 to-purple-400 bg-clip-text text-transparent">PDF</span>
                <span className="text-white"> Converter</span>
              </h1>
              <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
                Convert HTML code or webpages to professional PDF documents instantly
              </p>
            </div>
