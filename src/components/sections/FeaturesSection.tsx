...
import { Check, FileImage, Clock, FileCheck, Star, Shield } from 'lucide-react';
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-6 gap-4 mt-6">
          ...
          <div className="glass-card p-4 rounded-xl flex flex-col items-center text-center feature-card opacity-0">
            ...
            <p className="text-sm text-muted-foreground">
              All processing happens locally, with no data transferred to external servers, keeping your files completely secure.
            </p>
          </div>
        </div>
      </div>
