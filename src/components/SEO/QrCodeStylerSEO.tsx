...
const QrCodeStylerSEO = () => {
  return (
    <SEOMetadata 
      title="QR Code Styler | Create Beautiful Custom QR Codes"
      ...
      keywords="qr code styler, custom qr codes, qr code generator, qr code with logo, colored qr codes, stylish qr codes, designer qr codes"
      canonicalUrl="/qr-code-styler"
    />
  );
};
